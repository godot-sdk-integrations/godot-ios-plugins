...
lipo -create "./bin/tvos/lib$1.x86_64-simulator.$2.a" "./bin/tvos/lib$1.arm64-simulator.$2.a" -output "./bin/tvos/$1-simulator.$2.a"
lipo -create "./bin/tvos/lib$1.armv7-iphone.$2.a" "./bin/tvos/lib$1.arm64-iphone.$2.a" -output "./bin/tvos/$1-device.$2.a"

# Creating a xcframework 
xcodebuild -create-xcframework \
    -library "./bin/tvos/$1-device.$2.a" \
    -library "./bin/tvos/$1-simulator.$2.a" \
